<?php
    ...
    $sql = "SELECT * FROM tbl_doctor AS d, tbl_department AS p WHERE d.department_id=p.department_id AND doctor_id='$doctor_id'";
    $result=mysqli_query($conn, $sql);
    $row = mysqli_fetch_assoc($result);
    $department = "SELECT * FROM tbl_department";
    $all_department = mysqli_query($conn, $department);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body> 
        <div class="wrapper" style="height: 1000px;">
            ...
            <div class="main-panel">
                ...
                <?php require 'content/edit_doctor.php'; ?>

<?php
    ...
    $sql = "INSERT INTO tbl_report (patient_id,test_id,report_description,report_result,report_published_date) VALUES ('$patient_id','$test_id','$report_description','$report_result','$report_published_date')";
?> 
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body> 
        <div class="wrapper" style="height: 1000px;">
            ...
            <div class="main-panel">
                ...
                <?php require 'content/add_report.php'; ?>
